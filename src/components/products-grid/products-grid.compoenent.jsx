    ...
    return (
        <>
            <div className="products-grid">
                <ProductsItem imgUrl={'Apples.jpg'} name={"Baby Spinach"} newPrice={'1.60$'} oldPrice={'2.00$'} promo={'20%'}/>
                <ProductsItem imgUrl={'BabySpinach.jpg'} name={"Baby Spinach"} newPrice={'0.60$'} oldPrice={null} promo={null}/>
                <ProductsItem imgUrl={'blueberries.jpg'} name={"Blueberries"} newPrice={'3.00$'} oldPrice={null} promo={null}/>
                <ProductsItem imgUrl={'BrusselsSprouts.jpg'} name={"Brussels Sprouts"} newPrice={'3.00$'} oldPrice={null} promo={'30%'}/>
                <ProductsItem imgUrl={'Apples.jpg'} name={"Baby Spinach"} newPrice={'1.60$'} oldPrice={'2.00$'} promo={'20%'}/>
                <ProductsItem imgUrl={'BabySpinach.jpg'} name={"Baby Spinach"} newPrice={'0.60$'} oldPrice={null} promo={null}/>
                <ProductsItem imgUrl={'blueberries.jpg'} name={"Blueberries"} newPrice={'3.00$'} oldPrice={null} promo={null}/>
                <ProductsItem imgUrl={'BrusselsSprouts.jpg'} name={"Brussels Sprouts"} newPrice={'3.00$'} oldPrice={null} promo={'30%'}/>
